...
<link href="<?php echo base_url(); ?>css/jquery-ui-1.10.3.custom.min.css" type="text/css" rel="stylesheet" >
...
<body>
    ...
    <div id="wrap">
        ...
        <div id="content">
            ...
            <a style="z-index: 9999;" href="<?php echo base_url(); ?>admin" class="btn btn-primary btn-block">Administración</a>
            <?php } ?>